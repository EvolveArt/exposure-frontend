...
const Faq = [
	...
	},
	{
		title: "What are curated drops ? How do they work ?",
		desc:
			"Each month, Exposure builds a season of 3 to 5 photographic projects selected according to a specific theme, as for an exhibition. The projects are composed of at least 30 photographs available in the form of unique 1/1 NFTs.\n" +
	...
	{
		title:
			"When I buy an NFT on Rhapsody Curated, do I own the copyright of the work ?",
		desc:
		...
		<>
			...
			<Flex
				...
				<Text
					...
					// lineHeight="56px"
					marginLeft='10px'>
					Here, you’ll find answers to the questions we get all the time. If
					yours is not answered here, don’t hesitate to get in touch via our
					Twitter (@rhapsodycurated).
				</Text>
